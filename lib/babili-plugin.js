...
module.exports = class BabiliPlugin extends Plugin {
  constructor(tree, _options) {
    ...
    this.annotation = 'broccoli-babili';
  }
  ...
  build() {
    ...
    files.forEach(relativePath => {
      ...
      let haveProcessedOutputPath = seen[fullOutputPath];

      seen[fullOutputPath] = true;

      // create directories
      if (!haveProcessedOutputPath && relativePath.endsWith('/')) {
